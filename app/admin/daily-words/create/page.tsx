...
import { useCreateDailyWord } from "@/hooks/query/useAdmin";
import ImagePickerModal from "@/components/common/image-picker-modal";
import toast from "react-hot-toast";

const CreateDailyWordPage: FC = (): JSX.Element => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Daily word created!");
      router.push("/admin/daily-words");
    } catch (err: unknown) {
      const message =
        err instanceof Error ? err.message : "Failed to create daily word";
      toast.error(message);
    }
  };
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Create Daily Word</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Enter the quote or word of the day"
            rows={4}
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g. Rumi, Maya Angelou"
            className="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Optional: Add your thoughts or commentary on this quote"
            rows={4}
            className="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent resize-none"
          />
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mb-3">
            Select images from your gallery or paste a URL.
          </p>
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          >
            <FiSave size={16} />
            {createMutation.isPending ? "Creating..." : "Create Daily Word"}
          </button>
          <Link
            href="/admin/daily-words"
...
export default CreateDailyWordPage;
