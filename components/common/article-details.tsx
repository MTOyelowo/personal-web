  ...
  return (
    ...
    >
      {withThumbnail && article.thumbnailUrl ? (
        <>
          ...
          <div className="sm:absolute sm:top-0 sm:left-0 sm:right-0 sm:z-10 p-3 lg:p-4">
            <div className="sm:bg-white/95 sm:backdrop-blur-sm sm:rounded-lg sm:p-3 lg:p-4 sm:shadow-sm">
              ...
              <h1 className="text-sm sm:text-base lg:text-xl leading-snug font-libre font-bold text-foreground mt-0.5">
                {truncateText(article.title, 40)}
              </h1>
              <div className="flex flex-wrap text-muted-foreground mt-1.5 gap-1.5 sm:gap-2 text-xs lg:text-sm">
              ...
              <p className="text-xs lg:text-sm text-foreground/70 mt-1.5 leading-relaxed line-clamp-2">
        ...
        <>
          <h3 className="text-sm lg:text-xl text-muted-foreground uppercase">
            {article.category.name}
          </h3>
          <h1 className="text-[20px] lg:text-[33px] leading-[25px] lg:leading-10 font-libre font-bold text-foreground">
            {truncateText(article.title, 40)}
          </h1>
          <div className="flex text-muted-foreground mt-3 mb-3.5 gap-2.5">
